...
class InputParser:
    ...
    def _store_flight_data(self):
        """
        Read .csv file containing flights data and store each flight from the table in namedtuple as
